export class Vector3 implements Vector3 {
  public static create(v1: number | Vector3): Vector3 {
    if (typeof v1 === "number") {
  ...
  public static clone(v1: Vector3): Vector3 {
  ...
  public static multiply(v1: Vector3, v2: Vector3 | number): Vector3 {
    if (typeof v2 === "number") {
      return new Vector3(v1.x * v2, v1.y * v2, v1.z * v2);
    }
    return new Vector3(v1.x * v2.x, v1.y * v2.y, v1.z * v2.z);
  ...
  public static divide(v1: Vector3, v2: Vector3 | number): Vector3 {
    if (typeof v2 === "number") {
      return new Vector3(v1.x / v2, v1.y / v2, v1.z / v2);
    }
    return new Vector3(v1.x / v2.x, v1.y / v2.y, v1.z / v2.z);
  ...
  public add(v: number | Vector3): Vector3 {
